...
module.exports = class extends Base {
  ...
  detailAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      const attribute = yield _this3.model('goods_attribute').field('weshopth_goods_attribute.value, weshopth_attribute.name').join('weshopth_attribute ON weshopth_goods_attribute.attribute_id=weshopth_attribute.id').order({ 'weshopth_goods_attribute.id': 'asc' }).where({ 'weshopth_goods_attribute.goods_id': goodsId }).select();
